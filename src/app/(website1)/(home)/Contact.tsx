  ...
  return (
    <div className="">
      ...
      <div className="flex-column relative mx-auto mt-8 max-w-[900px] gap-6">
        ...
        <div className="left-0 top-[10%] mx-auto w-full max-w-xl rounded-md bg-secondary shadow-sm max-lg:h-min lg:absolute lg:min-h-[360px] lg:max-w-[320px] lg:rounded-sm">
