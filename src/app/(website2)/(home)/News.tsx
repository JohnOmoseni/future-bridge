...
function News() {
	return (
		<div className="section">
			...
			<ul className="mt-12 flex-column sm:grid grid-cols-2 gap-x-6 gap-y-7">
				{[1, 2, 3].map((card, idx) => (
					<li
						key={idx}
						className="md:min-w-[410px] row-flex-start gap-5 !items-start group relative w-full overflow-hidden rounded-xl transition hover:shadow-sm max-sm:min-w-[300px]"
					>
						...
						<div className="flex-column self-stretch flex-1 w-full gap-2 py-3 pr-4">
							...
							<p className="text-sm leading-5 my-1 max-sm:pr-3 pr-2">
